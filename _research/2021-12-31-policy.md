...
<center><video controls="" width="80%" height="80%"><source src="{{ ICRA2021_video.mp4 | prepend: '/assets/video/' | relative_url }}" type="video/mp4">Your browser does not support the video tag.</video></center>
